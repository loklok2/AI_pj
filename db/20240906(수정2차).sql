...
CREATE TABLE `product` (
  ...
  `price` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '상품 가격',
...
CREATE TABLE `shipment` (
  ...
  `order_shipping_address_id` bigint DEFAULT NULL,
  PRIMARY KEY (`ship_id`),
  KEY `order_id` (`order_id`),
  KEY `fk_shipment_shipping_address` (`shipping_address_id`),
  KEY `fk_shipment_order_shipping_address` (`order_shipping_address_id`),
  CONSTRAINT `fk_shipment_order_shipping_address` FOREIGN KEY (`order_shipping_address_id`) REFERENCES `orders` (`shipping_address_id`),
...
-- Dump completed on 2024-09-06  9:46:49
