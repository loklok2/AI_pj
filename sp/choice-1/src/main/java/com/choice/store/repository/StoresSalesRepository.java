...
public interface StoresSalesRepository extends JpaRepository<StoresSales, Long> {
        ...
        // "ORDER BY total_quantity DESC " +
        // "LIMIT 5", nativeQuery = true)
        // List<Object[]> findTop5SellingProductsByYearAndMonth(@Param("year") int year,
        ...
        // "FROM stores_sales s " +
        // "JOIN stores_products p ON s.product_id = p.product_id " +
        // "WHERE YEAR(s.sale_date) = :year AND MONTH(s.sale_date) = :month AND
        // DAY(s.sale_date) = :day " +
        // "GROUP BY p.product_id, p.product_name " +
        // "ORDER BY total_quantity DESC " +
        // "LIMIT 5", nativeQuery = true)
        // List<Object[]> findTop5SellingProductsByYearMonthDay(@Param("year") int year,
        // @Param("month") int month,
        // @Param("day") int day);
        ...
        // "ORDER BY total_quantity DESC " +
        // "LIMIT 5", nativeQuery = true)
        // List<Object[]> findTop5SellingProductsByStoreAndYear(@Param("storeId") Long
        // storeId, @Param("year") int year);
        ...
        // "FROM stores_sales s " +
        // "JOIN stores_products p ON s.product_id = p.product_id " +
        // "WHERE s.store_id = :storeId AND YEAR(s.sale_date) = :year AND
        // MONTH(s.sale_date) = :month " +
        // "GROUP BY p.product_id, p.product_name " +
        // "ORDER BY total_quantity DESC " +
        // "LIMIT 5", nativeQuery = true)
        // List<Object[]>
        // findTop5SellingProductsByStoreAndYearAndMonth(@Param("storeId") Long storeId,
        ...
        // "ORDER BY total_quantity DESC " +
        // "LIMIT 5", nativeQuery = true)
        // List<Object[]> findTop5SellingProductsByStoreAndDate(@Param("storeId") Long
        // storeId, @Param("date") Date date);
        ...
        // "JOIN stores_products p ON s.product_id = p.product_id " +
        // "WHERE s.store_id = :storeId AND YEAR(s.sale_date) = :year AND
        // MONTH(s.sale_date) = :month AND DAY(s.sale_date) = :day "
        // +
        // "GROUP BY p.product_id, p.product_name " +
        // "ORDER BY total_quantity DESC " +
        // "LIMIT 5", nativeQuery = true)
        // List<Object[]>
        // findTop5SellingProductsByStoreAndYearMonthDay(@Param("storeId") Long storeId,
        // @Param("year") int year, @Param("month") int month, @Param("day") int day);

        // // 1.매장별 매출 조회 년도별
        // @Query(value = "SELECT s.store_id, st.store_name, SUM(s.price * s.quantity)
        // as total_sales " +
        // "FROM stores_sales s " +
        ...
        // "GROUP BY s.store_id, st.store_name " +
        // "ORDER BY total_sales DESC", nativeQuery = true)
        // List<Object[]> findSalesByStoreAndYearAndMonth(@Param("year") int year,
        // @Param("month") int month);
        ...
        // "GROUP BY s.store_id, st.store_name " +
        // "ORDER BY total_sales DESC", nativeQuery = true)
        // List<Object[]> findSalesByStoreAndYearMonthDay(@Param("year") int year,
        // @Param("month") int month,
        // @Param("day") int day);
        ...
        // Object[] findSalesByStoreIdAndYear(@Param("storeId") Long storeId,
        // @Param("year") int year);
        ...
        // MONTH(s.sale_date) = :month " +
        // "GROUP BY s.store_id, st.store_name", nativeQuery = true)
        // Object[] findSalesByStoreIdAndYearAndMonth(@Param("storeId") Long storeId,
        // @Param("year") int year,
        // @Param("month") int month);
        ...
        // "WHERE s.store_id = :storeId AND s.sale_date = :date " +
        // "GROUP BY s.store_id, st.store_name", nativeQuery = true)
        // Object[] findSalesByStoreIdAndDate(@Param("storeId") Long storeId,
        ...
        // +
        // "GROUP BY s.store_id, st.store_name", nativeQuery = true)
        // Object[] findSalesByStoreIdAndYearMonthDay(@Param("storeId") Long storeId,
        // @Param("year") int year,
