...
if __name__ == '__main__':
    ...
    style_dict = {0: "클래식", 1: "매니시", 2: "페미니", 3: "에스닉", 4: "컨템포러리", 
                           5: "내추럴", 6: "젠더리스", 7: "스포티", 8: "서브컬처", 9: "캐주얼"}
    
    img_path = 'img/K-fashion(2)/398594/u_157016535268216900_2020788524.jpg'
    img = Image.open(img_path)
    img_np = np.array(img)
    plt.imshow(img_np)

    predictions = predictor.predict(img)
    pred_list = [style_dict[num] for num in predictions]
    print(pred_list, "num : ", predictions)
